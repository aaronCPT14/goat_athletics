...
products[0] = new Product("asics", "Asics Shoe",  60.00);
products[1] = new Product("rosche", "Nike Rosche",    50.00);
products[2] = new Product("pumalow", "Pumas Low",  55.00);
products[3] = new Product("sc30", "Curry One",  150.00);
products[4] = new Product("nikefly", "Nike FlyKnit",  85.00);
products[5] = new Product("adidsb", "Adidas Spring Blade",  75.00);
products[6] = new Product("asicsshirt", "Asics Athletic Shirt",  30.00);
products[7] = new Product("asicst-shirt", "Asics T-Shirt",    30.00);
products[8] = new Product("jordant", "Jordan T-Shirt",  60.00);
products[9] = new Product("ua", "UA T-Shirt",  45.00);
products[10] = new Product("adidasshirt", "UEFA EURO 2016 GERMANY HOME PRE-MATCH SHIRT",  50.00);
products[11] = new Product("adidasspain", "UEFA EURO 2016 SPAIN AWAY PRE-MATCH SHIRT",  50.00);
products[12] = new Product("micoach", "Adidas MiCoach Smart Ball",  200.00);
products[13] = new Product("wilson", "Wilson A2000",    249.95);
products[14] = new Product("navy", "Naval Academy Jersey",  80.00);
products[15] = new Product("football", "Wilson Football",  100.00);
products[16] = new Product("nike", "Nike Basketball",  100.00);
products[17] = new Product("lacrosse", "Thompson Brothers Lacrosse",  125.00);
...
var shipping_rate = 5.59; // (will not be applied if free_shipping = true)
